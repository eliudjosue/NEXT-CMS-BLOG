...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${firaCode.className} flex flex-col h-screen bg-amber-50 text-indigo-950 dark:bg-slate-950 dark:text-amber-50 dark:selection:bg-purple-500`}
      >
        <Provider>
          <Navbar />
          <main className="flex-grow mx-auto max-w-5xl px-6">{children}</main>
          <Footer />
        </Provider>
      </body>
    </html>
